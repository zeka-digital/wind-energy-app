...
MAX_CONCURRENT_TABS = 1    # ปรับเหลือ 1 เพราะรันแค่ตัวเดียว
MAX_WAIT = 60
RETRIES = 2
HEADLESS_MODE = False

# รอ 2 นาที ก่อนเริ่มรอบใหม่ ทดสอบลดค่าลงดู
LOOP_DELAY_SECONDS = 10

SERVICE_ACCOUNT_FILE = "scada-key.json" # ชื่อไฟล์กุญแจเหมือนพนักงานหุ่นยนต์ของเรา
SPREADSHEET_NAME = "Enos_Wind_Monitoring_DB" # ชื่อใหม่ที่เราตั้งร่วมกัน
WORKSHEET_NAME = "Live_Status_1Pole" # ชื่อแท็บใหม่
...
# =====================================================
# LOAD TARGETS (แก้ไขให้ดึงแค่ 1 ตัว)
# =====================================================
...
async def main():
    ...
    # โหลด URL (ซึ่งตอนนี้แก้ให้เหลือ 1 อันแล้ว)
