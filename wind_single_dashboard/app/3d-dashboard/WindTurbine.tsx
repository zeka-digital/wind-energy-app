...
export default function WindTurbine({
  ...
  // Animate the blades rotation based on activePower
  ...
  // For single turbine view, face directly towards camera
  // Camera is at [-15, 12, 25], turbine at [0, 0, 0]
  // Calculate angle to face camera: atan2(cameraZ - turbineZ, cameraX - turbineX)
  const facingRotation = Math.atan2(25 - position[2], -15 - position[0]);
